<template>
      ...
      <div class="public-key-section">
        <div class="public-key-item" v-for="(publicKey, index) in publicKeys" :key="index">
          <div class="public-key-wrapper">
            <!-- 添加SVG小图标 -->
            <img src="../assets/img/happyface.svg" alt="Happy Face" class="icon" v-if="index === 0" />
            <img src="../assets/img/headphone.svg" alt="Headphone" class="icon" v-if="index === 1" />
            <img src="../assets/img/happyface.svg" alt="Else" class="icon" v-if="index === 2" />
  ...
  .public-key-item {
    ...
    align-items: center;
    margin-top: 20px;
    border: 4px solid #ccc; /* 添加边框 */
    border-radius: 5px;
    padding: 10px;
    height: 50px /* 修改整个框的宽度 */
