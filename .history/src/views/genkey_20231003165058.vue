      ...
      <div class="public-key-section">
        <div class="public-key-item" v-for="(publicKey, index) in publicKeys" :key="index">
          <div class="public-key-wrapper">
            <!-- 添加SVG小图标 -->
            <div class="icon">
              <img :src="getIconPath(publicKey.name)" alt="Icon" class="icon-image" />
            </div>
  ...
  export default {
    ...
    methods: {
      ...
      getIconPath(keyName) {
        ...
        switch (keyName) {
          case '公钥1':
            return require('@/assets/img/happyface.svg');
          case '公钥2':
            return require('@/assets/img/headphone.svg');
          default:
            return require('@/assets/img/else.svg');
        }
      },
    },
  };
